...
def helpFunc(pcbs, Args):
    ...
    print("\thelp: displays the BOM tool commands\n")
    print("\tload: loads a new PCB BOM into the program")
    print("\t\t--list: prints a list of supported PCBs\n")
    print("\tproduction: creates a new production BOM\n")
...
def parseInput(userin, pcbs): 
    ...
    for command in commands: 
        if userCommand == command:
           pcbs = commands[command](pcbs, CommandArgs)
           return pcbs
